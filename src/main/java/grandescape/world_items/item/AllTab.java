...
public class AllTab {
    ...
    public static final Supplier<CreativeModeTab> GRANDESCAPE = CREATIVE_MODE_TAB.register("grand_escape_tab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(GrandBlocks.CANNON_BALL_PILE))
                    .withTabsBefore(ResourceLocation.fromNamespaceAndPath(GrandEscape.MODID, "grand_escape_tab"))
                    .title(Component.translatable("creativetab.grandescape.grand_escape_tab"))
